...
export default class EditProfile extends Component {
  handleSave(){
    document.getElementById("edit-profile-tabs-tab-2").click();
  }
  handleSave1(){
    document.getElementById("edit-profile-tabs-tab-3").click();
  }
  handleSave2(){
    document.getElementById("edit-profile-tabs-tab-5").click();
  }
  handleSave3(){
    document.getElementById("edit-profile-tabs-tab-6").click();
  }
  handleSave4(){
    document.getElementById("edit-profile-tabs-tab-6").click();
  }
          ...
          <Col xs={10}>
            <Tabs defaultActiveKey={1} id="edit-profile-tabs" style={style.allTabs}>
              ...
              <Jumbotron>
                ...
                <Form inline style={style.form}>
                  <FormGroup controlId="formInlineChildren">
                    <ControlLabel>Number of Children</ControlLabel>{' '}
                    <FormControl type='number' min='0' max='10' defaultValue='0' />
                  </FormGroup>{' '}
                </Form>
                ...
                <Button bsStyle='' style={style.saveBtn} onClick={this.handleSave}>
              ...
              <div>
                ...
                <Form inline style={style.form}>
                  ...
                  <Button bsStyle='' style={style.saveBtn} onClick={this.handleSave1}>
                    <i class="fas fa-save"></i> Save
                  </Button>
                </Jumbotron>
                </div>
              ...
              <Tabs defaultActiveKey={1} id="edit-Benefits-tabs">
                    ...
                    <Button bsStyle='' style={style.saveBtn} onClick={this.handleSave2}>
                      <i class="fas fa-save"></i> Save
                    </Button>
                    </Jumbotron>
                    </Tab>
                    ...
                    <Tab eventKey={5} title='Deductions'>
                      ...
                      <Form inline style={style.incomeForm}>
                        ...
                        <FormGroup controlId="formInlineMontlyIncome">
                            ...
                            <InputGroup>
                              <InputGroup.Addon><i class="fas fa-euro-sign"></i></InputGroup.Addon>
                              <FormControl type="number" min='0' defaultValue='750'/>
                            </InputGroup>
                        </FormGroup>{' '}
                        </Form>
                        <Form>
                        <FormGroup controlId="formInlineDeductions">
                            ...
                            <InputGroup>
                              <InputGroup.Addon><i class="fas fa-euro-sign"></i></InputGroup.Addon>
                              <FormControl type='number' min='0' defaultValue='1000'/>
                            </InputGroup>
                        </FormGroup>
                      </Form>
                      <Button bsStyle='' style={style.saveBtn} onClick={this.handleSave3}>
                        <i class="fas fa-save"></i> Save
                      </Button>
                      </Jumbotron>
                    </Tab>
